...
const TopNavigation = () => {
  ...
  const menuItems = [
    ...
    { icon: Swords, label: 'Duels', path: '/app/duels' },
    { icon: Users, label: 'Duellistes', path: '/app/duellistes' },
    { icon: Calendar, label: 'Nouveau', path: '/app/nouveau-duel' },
    ...
    <nav className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 shadow-sm z-50 pt-8">
      <div className="px-4 py-3">
        ...
        <div className="flex items-center justify-center mb-3">
          <img src="/logo_cey.png" alt="Cercle d'Escrime de Yerres" className="w-8 h-8 mr-2" />
