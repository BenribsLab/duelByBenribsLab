...
import { Trophy, Target, Calendar, Award, Swords, Crown } from 'lucide-react';
...
const Duellistes = () => {
  ...
  const handleChallenge = (adversaireId) => {
    ...
    navigate(`/nouveau-duel?adversaire=${adversaireId}`);
  };
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-3">
        {duellistes.map((dueliste) => {
          const rang = getRang(dueliste.id);
          const rangColor = getRangColor(rang);
          const rangIcon = getRangIcon(rang);
            ...
            <div key={dueliste.id} className="bg-white shadow rounded-lg p-4 flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* Rang */}
                  {rang && (
                    <div className={`flex items-center ${rangColor}`}>
                      {rangIcon}
