#!/usr/bin/env node
/**
 * Migration : ajout de la table de consentement parental (`parental_consents`).
 *
 ...
 *
 * Usage :
 *   node scripts/migrate-parental-consent.js --dry-run   # affiche le plan, n'écrit rien
 *   node scripts/migrate-parental-consent.js             # applique la migration
 */
...
async function main() {
  ...
  const sqlFile = path.join(__dirname, '..', 'prisma', 'manual', `add_parental_consent.${engine}.sql`);
